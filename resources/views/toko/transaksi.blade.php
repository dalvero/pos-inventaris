...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <div class="p-4 xl:ml-0">
        ...
        <div class="mb-8 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm font-semibold text-gray-600">
                    Lihat hasil penjualan berdasarkan tanggal
                </p>
            </div>

            <a href="{{ route('toko.dashboard') }}">
                <button
                    class="px-4 py-2 bg-blue-600 text-white rounded-lg font-bold shadow hover:bg-blue-700 transition">
        ...
        <div class="mb-6 bg-white rounded-xl shadow-lg p-6">
            <form method="GET" action="{{ route('toko.transaksi') }}" class="flex items-end gap-4">
                <div class="flex-1">
                ...
                <button 
                    type="submit"
                    class="px-6 py-2 bg-violet-600 text-white rounded-lg font-bold shadow hover:bg-violet-700 transition">
                    Tampilkan
                </button>
            </form>
        </div>
        ...
        <div class="mb-6 bg-white rounded-xl shadow-lg p-6">
            <h3 class="text-lg font-semibold text-gray-700 mb-2">
                Total Penjualan Tanggal {{ \Carbon\Carbon::parse($tanggal)->format('d M Y') }}
            </h3>            
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="p-4 text-center text-gray-500">
                                Belum ada data transaksi pada tanggal {{ \Carbon\Carbon::parse($tanggal)->format('d M Y') }}.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
...
<script>
    ...
    const allTransaksis = @json($allTransaksis);
