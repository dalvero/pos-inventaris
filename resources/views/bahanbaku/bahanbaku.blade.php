                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="p-4 border-b border-gray-200">
                                <div class="flex gap-2">
                                    ...
                                    {{-- DELETE --}}
                                    <button 
                                        onclick="deleteBahanBaku({{ $bahan->id }})"
                                        class="cursor-pointer p-2 text-red-600 hover:bg-red-50 rounded-lg transition"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="p-6 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <p class="block antialiased font-sans text-sm leading-normal text-gray-700 font-normal">
                    Menampilkan 1 - 5 dari {{Auth::user()->toko->bahanBakus->count()}} data
                </p>
                <div class="flex gap-2">
                    ...
                    <button class="px-3 py-2 text-sm font-medium text-white bg-linear-to-tr from-violet-700 to-violet-950 rounded-lg">
                        1
                    </button>
                    <button class="px-3 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                        Selanjutnya
