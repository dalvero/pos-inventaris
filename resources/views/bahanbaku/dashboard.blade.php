...
<div class="p-4 xl:ml-0">
    ...
    <div class="mb-8">
        ...
        <p class="text-sm font-semibold text-gray-600">
            Berikut adalah overview dan statistik bahan baku di {{Auth::user()->toko->nama_toko}} milik anda.
        </p>
    </div>
        ...
        <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                ...
                <div class="p-4 text-right">
                    <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total Bahan Baku</p>
                    <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                        {{Auth::user()->toko->bahanBakus()->count()}}
                    </h4>
                </div>
                <div class="border-t border-blue-gray-50 p-4">
                    <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                        Ada
                        <strong class="text-blue-500">{{Auth::user()->toko->bahanBakus()->count()}}</strong>&nbsp;bahan baku yang tersedia di {{Auth::user()->toko->nama_toko}}
                    </p>
                </div>
            </div>
