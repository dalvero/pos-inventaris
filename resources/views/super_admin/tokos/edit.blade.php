...
<div class="p-4 xl:ml-0">
    ...
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
        <div class="p-6">
            <form action="{{ route('super_admin.tokos.update', $toko->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    >
                        ...
                        @forelse($admins as $admin)
                            <option value="{{ $admin->id }}" {{ old('user_id', $toko->user_id) == $admin->id ? 'selected' : '' }}>
                ...
                @if($toko->qr_image)
                    <div class="mb-6">
                        ...
                        <img src="{{ asset('storage/' . $toko->qr_image) }}" alt="QR Code" class="max-w-xs h-auto rounded-lg shadow-lg">
                    </div>
                @endif
                ...
                <div class="mb-6">
                    <label for="qr_image" class="block text-sm font-semibold text-gray-700 mb-2">
                        Ganti QR Code Image <span class="text-gray-500">(Kosongkan jika tidak ingin mengubah)</span>
                    </label>
                    <input 
                        type="file" 
                        id="qr_image" 
                    ...
                    <div id="imagePreview" class="mt-4 hidden">
                        <p class="text-sm font-semibold text-gray-700 mb-2">Preview QR Code Baru:</p>
