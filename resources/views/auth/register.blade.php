...
<head>
    ...
    <body class="bg-gray-100 font-sans text-gray-700 font-semibold">
        @if ($errors->any())
            <div 
                ...
                class="fixed right-5 top-5 z-50 w-[380px]
                    ...
                    transition duration-150 ease-linear flex gap-3"
            >
                ...
                <!-- TEXT -->
                <div class="flex-1">
                    <p class="text-base text-red-700 font-semibold">Form tidak lengkap!</p>
                ...
                <button 
                    @click="show = false" 
                    class="text-red-600 hover:text-red-800 transition mt-1"
                >
        ...
        <div class="max-w-md mx-auto mt-20 mb-10 p-6 bg-graybg border border-gray-700 rounded-lg">
